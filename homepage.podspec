...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Lianxiaoya0/homepage'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Lianxiaoya0' => 'lianxiaoya@syswin.com' }
  s.source           = { :git => 'https://github.com/Lianxiaoya0/homepage.git', :tag => s.version.to_s }
